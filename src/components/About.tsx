      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {[
            ...
            <div
              key={index}
              className="text-center bg-gradient-to-br from-[#5B21B6] to-[#DB2777] backdrop-blur-sm rounded-2xl p-6 border-2 border-[#06B6D4] shadow-lg"
            >
              <div className="text-3xl md:text-4xl font-bold text-white mb-2 flex items-center justify-center gap-2">
                ...
                {stat.icon && <stat.icon size={32} className="text-[#06B6D4]" />}
              </div>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <h3 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-[#7C3AED] to-[#DB2777] bg-clip-text text-transparent">
            Key Achievements
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-[#5B21B6] to-[#DB2777] rounded-2xl p-6 border-2 border-[#06B6D4] text-center shadow-lg">
              <div className="w-12 h-12 bg-[#06B6D4] rounded-full flex items-center justify-center mx-auto mb-4">
                <Award size={24} className="text-white" />
              </div>
              <div className="font-semibold text-white mb-2">Leadership</div>
              <div className="text-[#94A3B8] text-sm">Software Development Club Lead</div>
            </div>
            <div className="bg-gradient-to-br from-[#5B21B6] to-[#DB2777] rounded-2xl p-6 border-2 border-[#06B6D4] text-center shadow-lg">
              <div className="w-12 h-12 bg-[#06B6D4] rounded-full flex items-center justify-center mx-auto mb-4">
                <Award size={24} className="text-white" />
              </div>
              <div className="font-semibold text-white mb-2">Teaching</div>
              <div className="text-[#94A3B8] text-sm">Graduate Teaching Assistant for Database Systems</div>
            </div>
            <div className="bg-gradient-to-br from-[#5B21B6] to-[#DB2777] rounded-2xl p-6 border-2 border-[#06B6D4] text-center shadow-lg">
              <div className="w-12 h-12 bg-[#06B6D4] rounded-full flex items-center justify-center mx-auto mb-4">
                <Award size={24} className="text-white" />
              </div>
              <div className="font-semibold text-white mb-2">Research</div>
              <div className="text-[#94A3B8] text-sm">Graduate Research Assistant</div>
            </div>
          </div>
        </motion.div>
      </div>
